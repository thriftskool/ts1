...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setBackgroundColor:NavigationBarBgColor];
...
- (void)changeOrientationForIOS8: (NSNotification *)notification {
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
                     animations:^{
                         ...
                         dialogView.frame = CGRectMake((screenWidth1 - dialogSize.width) / 2, (screenHeight1 - keyboardSize.height - dialogSize.height) / 2, dialogSize.width, dialogSize.height);
                     }
                     completion:nil
     ];
