...
- (void)badgeInit
{
    ...
    self.badge.layer.cornerRadius = 11.0;
...
- (CGSize) badgeExpectedSize
{
    ...
    frameLabel.layer.cornerRadius = 11.0;
...
//    self.badge.layer.cornerRadius = (minHeight + padding) /0.25;//neha
    self.badge.layer.cornerRadius = 11.0;
...
- (UILabel *)duplicateLabel:(UILabel *)labelToCopy
{
    ...
    duplicateLabel.layer.cornerRadius = 11.0;
