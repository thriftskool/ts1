...
(function ($) {
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            untilButtonText: 'Until'           // Text for the until button
        };
    ...
    $.extend(Timepicker.prototype, {
        ...
        _rebindDialogEvents: function (inst) {
            ...
            .find('.ui-timepicker-until').bind("click", function(e) {
                      $.timepicker.selectUntil(e);  
        ...
        _generateHTML: function (inst) {
            ...
            var h, m, row, col, html, hoursHtml, minutesHtml = '',
                ...
                showUntilButton = this._get(inst, 'showUntilButton'),
                untilButtonText = this._get(inst, 'untilButtonText'),
                showButtonPanel = showCloseButton || showNowButton || showDeselectButton || showUntilButton;
            ...
            if (showButtonPanel) {
                ...
                if (showUntilButton) {
                    buttonPanel += '<button type="button" class="ui-timepicker-until ui-state-default ui-corner-all" '
                                   + ' data-timepicker-instance-id="#' + inst.id.replace(/\\\\/g,"\\") + '" >'
                                   + untilButtonText + '</button>';
                }
...
*/
        ...
        */
        ...
        selectUntil: function(event) {
            var id = $(event.target).attr("data-timepicker-instance-id"),
            $target = $(id),
            inst = this._getInst($target[0]);
            //alert(inst.id);  
            if(inst.id=='dt_endtime1')
            {
                $('#chr_until1').val('Y'); 
                $('#dt_endtime1').val('11:55 PM');
            }
            else if(inst.id=='dt_endtime2')
            {                
                $('#chr_until2').val('Y');
                $('#dt_endtime2').val('11:55 PM');
            }
//            var currentTime = new Date();
//            inst.hours = '23';            
//            inst.minutes = '55';
