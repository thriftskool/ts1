...
class Adminpanel_campus_gallery extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();

        $this->load->model('campus_gallery_model', 'module_model');                       // MODULE MODEL
        $this->main_tpl = 'adminpanel/campus_gallery_tpl';                 // MODULE MAIN VIEW
        $this->add_tpl = 'adminpanel/campus_gallery_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/campus_gallery/';          // MODULE URL    
    }
    ...
    public function add() {
        ...
        if (!empty($eid)) {
            ...
            $action = redirect(SITE_PATH . 'adminpanel/campus_gallery');
        }
...
//
//                $eid = $this->input->get_post('eid');
//                redirect(base_url() . 'adminpanel/campus_gallery/add?' . 'eid=' . $eid);
//            } else {
//                $this->redirect_to_page($this->input->get_post('ehintglcode'), 'edit');
//            }
//        }
