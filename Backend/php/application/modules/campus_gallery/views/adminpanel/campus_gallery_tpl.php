...
<a href="<?= SITE_PATH.'adminpanel/campus_deal'; ?>">Manage Deals</a>&nbsp;&gt;&nbsp;
        <span class="current">Manage Deal Gallery </span>
                                                    ...
                                                    <tr class="even gradeC"> 
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);">
                                                                <img id="tick-<?= $row->int_glcode ?>" height="16" width="16" alt="<?= $title ?>" title="<?= $title ?>" src="<?= ADMIN_MEDIA_URL . 'images/' ?><?= $tickimg ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('campus_gallery', '<?= DB_PREFIX . 'campus_gallery' ?>', 'chr_publish', '<?= $row->int_glcode ?>', '');">
                                                            </a>
                                                        </td>
