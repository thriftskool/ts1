...
<div id="gridbody">
    <div class="breadcrumbs">
        ...
        <span class="current">Manage Post Category </span>
    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <a href="javascript:;" onclick="SendGridBindRequest('<?= $this->module_model->urlwithoutsort ?>&orderby=var_categoryname&sorting=Y','gridbody','ST')">Post Category
                                            <?php echo $setsortimgvar_categoryname; ?>
                                            </a>
                                        </th>
                                                    ...
                                                    <tr class="even gradeC"> 
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($imagename != "") {
                                                                ...
                                                                $imagepath = 'upimages/post_category/images/' . $imagename;
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($imagename != "") {
                                                                ...
                                                                if (file_exists($imagepath)) {
                                                                    ?>
                                                                    <div class="highslide-gallery">
                                                                        <a onClick="return hs.expand(this);" href="<?php echo SITE_PATH . $imagepath; ?>"><img border="0" src="<?= ADMIN_MEDIA_URL ?>images/photo-gallery-icon.png" title="<?= $row->var_backimage; ?>"></a>
                                                                    <?php } else { ?>
                                                                        <a onClick="return hs.expand(this);" href="<?= ADMIN_MEDIA_URL ?>images/no-image.gif"> <img border="0" src="<?= ADMIN_MEDIA_URL ?>images/photo-gallery-icon.png" title="<?= $row->var_backimage; ?>"></a>
                                                                    </div>
                                                                    <?php
                                                                }
                                                            } else {
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);">
                                                                <img id="tick-<?= $row->int_glcode ?>" height="16" width="16" alt="<?= $title ?>" title="<?= $title ?>" src="<?= ADMIN_MEDIA_URL . 'images/' ?><?= $tickimg ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('post_category', '<?= DB_PREFIX . 'post_category' ?>', 'chr_publish', '<?= $row->int_glcode ?>', '');">
                                                            </a>
                                                        </td>
