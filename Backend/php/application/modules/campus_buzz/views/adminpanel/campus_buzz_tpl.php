...
<div id="gridbody">
    <div class="breadcrumbs">
        ...
        <span class="current">Manage Campus Buzz </span>
    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <a href="javascript:;" onclick="SendGridBindRequest('<?= $this->module_model->urlwithoutsort ?>&orderby=var_title&sorting=Y','gridbody','ST')">Buzz Title
                                                ...
                                                foreach ($selectAll as $row) {
                                                    ...
                                                    <tr class="even gradeC"> 
                                                        ...
                                                        <td>
                                                          ...
                                                          ?>
                                                            (<?php echo $gall_count; ?>)<a href="<?php echo SITE_PATH?>adminpanel/campus_buzz_gallery?cid=<?= $row->int_glcode; ?>" class="edit-link-class">
                                                                View
                                                            </a><?php if($gall_count < 4) { ?> / <a href="<?php echo SITE_PATH.'adminpanel/campus_buzz_gallery/add?cid='.$row->int_glcode ?>" class="edit-link-class">
                                                                Add
                                                            </a> <?php } ?>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);">
                                                                <img id="tick-<?= $row->int_glcode ?>" height="16" width="16" alt="<?= $title ?>" title="<?= $title ?>" src="<?= ADMIN_MEDIA_URL . 'images/' ?><?= $tickimg ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('campus_buzz', '<?= DB_PREFIX . 'campus_buzz' ?>', 'chr_publish', '<?= $row->int_glcode ?>', '');">
                                                            </a>
                                                        </td>

                                                               <td>
                                                    <!--<a href="<?php echo SITE_PATH ?>adminpanel/post_management/view?pid=<?= $row->int_glcode; ?>" class="edit-link-class"> View</a>-->
                                                    <a href="<?php echo SITE_PATH ?>adminpanel/campus_buzz/view?bid=<?= $row->int_glcode; ?>" class="btn btn-xs btn-primary"> <i class="fa fa-search "></i> View</a>
                                                </td>
                                                    </tr>
                                                    <?php
                                                    $rowcount++;
