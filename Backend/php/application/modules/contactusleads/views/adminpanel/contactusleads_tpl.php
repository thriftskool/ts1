...
<div id="gridbody">
    <div class="breadcrumbs">
        ...
        <span class="current">Manage Contact Us<span>
                </div>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        ...
                                                        <a href="javascript:;" onclick="SendGridBindRequest('<?= $this->module_model->urlwithoutsort ?>&orderby=var_name&sorting=Y', 'gridbody', 'ST')">User Name
                                                ...
                                                if ($counttotal > 0) {
                                                    foreach ($selectAll as $row) {
                                                        ...
                                                        <tr class="even gradeC"> 
                                                            ...
                                                            <td>
                                                                <a href="javascript:;" onclick="return hs.htmlExpand(this, {headingText: 'Message'})">
                                                                    <img alt="" src="<?= ADMIN_MEDIA_URL ?>images/message-icon.png" />
                                                                </a>
                                                                <div class="highslide-maincontent">
                                                                    <?= nl2br(trim($row->var_message)) ?>
                                                                </div>
