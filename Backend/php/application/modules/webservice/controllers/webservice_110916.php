...
//            exit;
    ...
    function registration() {
        ...
        if ($registation->university_id != '' && $registation->email_id != '' && $registation->user_name != '' && $registation->password != '' && $registation->device_id) {
            echo $this->module_model->Get_Registration($registation->university_id, $registation->email_id, $registation->user_name, $registation->password, $registation->device_id);
            exit;
        } else {
            echo $this->module_model->Bad_Request_error_message();
            exit;
...
//echo "dsafsafa"; die;
    ...
    function edit_profile() {
        ...
        if ($profile_list->user_id != '' && $profile_list->university_id != '' && $profile_list->email_id != '' && $profile_list->var_username != '') {
            echo $this->module_model->Update_Edit_Profile($profile_list->user_id, $profile_list->university_id, $profile_list->email_id, $profile_list->var_username);
            exit;
        } else {
            echo $this->module_model->Bad_Request_error_message();
            exit;
