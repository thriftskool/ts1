...
class Adminpanel_university_leads extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();

        $this->load->model('university_leads_model', 'module_model');                       // MODULE MODEL
        $this->main_tpl = 'adminpanel/university_leads_tpl';                 // MODULE MAIN VIEW
        $this->add_tpl = 'adminpanel/university_leads_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/university_leads/';          // MODULE URL    
    }
...
//
//                $eid = $this->input->get_post('eid');
//                redirect(base_url() . 'adminpanel/university_leads/add?' . 'eid=' . $eid);
//            } else {
//                $this->redirect_to_page($this->input->get_post('ehintglcode'), 'edit');
//            }
//        }
