...
<div class="breadcrumbs">
    ...
    <a href="<?= MODULE_PAGE_NAME ?>?cid=<?php echo $this->input->get_post('cid'); ?>">Manage Buzz Gallery </a>&nbsp; &gt;&nbsp; 
    <?php
    if (!empty($eid)) {
        ?><span class="current">Edit Buzz Image</span>  <?php
    } else {
        ?><span class="current">Add Buzz Image</span> <?php
    }
    ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <?php
                $attributes = array('name' => 'frmbuzzgallery', 'id' => 'frmbuzzgallery', 'enctype' => 'multipart/form-data');
                ...
                ?>" name="var_image">
                                           <?php
                                           if (!empty($eid)) {
                                               $imagepath = 'upimages/campus_buzz_gallery/images/' . $row['var_image'];
                                               ?>
                                               <?php
