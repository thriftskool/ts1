...
//                    email:true
            ...
            messages: {
                ...
                var_title: 'Please enter deal title.',
...
<div class="breadcrumbs">
    ...
    <!--<a href="<?php echo SITE_PATH ?>adminpanel/campus_deal">Products </a>&nbsp;&gt;&nbsp;-->
    <a href="<?= MODULE_PAGE_NAME ?>">Manage Campus Deals </a>&nbsp; &gt;&nbsp; 
    <?php
    if (!empty($eid)) {
        ?><span class="current">Edit Deal</span>  <?php
    } else {
        ?><span class="current">Add Deal</span> <?php
    }
    ?>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group" style="padding-top: 10px; padding-bottom: 20px">
                                <label style="text-align:center" for="var_dealcode" class="col-sm-4 control-label">Deal Code </label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="var_dealcode" id="var_dealcode" value="<?php echo $row['var_dealcode']; ?>" >
                                </div>
                            </div>
