...
class Adminpanel_post_gallery extends AdminPanel_Controller {

    function __construct() {
        parent::__construct();

        $this->load->model('post_gallery_model', 'module_model');                       // MODULE MODEL
        $this->main_tpl = 'adminpanel/post_gallery_tpl';                 // MODULE MAIN VIEW
        $this->add_tpl = 'adminpanel/post_gallery_add_tpl';              // MODULE ADD  VIEW
        $this->module_url = base_url() . 'adminpanel/post_gallery/';          // MODULE URL    
    }
    ...
    public function add() {
        ...
        if (!empty($eid)) {
            ...
            $action = redirect(SITE_PATH . 'adminpanel/post_management');
        }
...
//
//                $eid = $this->input->get_post('eid');
//                redirect(base_url() . 'adminpanel/post_gallery/add?' . 'eid=' . $eid);
//            } else {
//                $this->redirect_to_page($this->input->get_post('ehintglcode'), 'edit');
//            }
//        }
