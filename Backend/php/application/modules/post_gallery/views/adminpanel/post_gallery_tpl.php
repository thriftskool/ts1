...
<script type="text/javascript">
    ...
    function verify()
    {
        ...
        SendGridBindRequest('<?php echo MODULE_PAGE_NAME ?>', 'gridbody', 'D', 'chkgrow','<?php echo MODULE; ?>');
    }
...
<a href="<?= SITE_PATH.'adminpanel/post_management'; ?>">Manage Posts</a>&nbsp;&gt;&nbsp;
        <span class="current">Manage Post Gallery </span>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <!--</div>-->
                                                    ...
                                                    <tr class="even gradeC"> 
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);">
                                                                <img id="tick-<?= $row->int_glcode ?>" height="16" width="16" alt="<?= $title ?>" title="<?= $title ?>" src="<?= ADMIN_MEDIA_URL . 'images/' ?><?= $tickimg ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('post_gallery', '<?= DB_PREFIX . 'post_gallery' ?>', 'chr_publish', '<?= $row->int_glcode ?>', '');">
                                                            </a>
                                                        </td>
                                        ...
                                        <input type="hidden" value="<?php echo $this->input->get_post('pid'); ?>" id="pid" name="pid">
                                        </tbody>
                                        </table>
                                        <!--                            </div>
                                                                </div>-->
