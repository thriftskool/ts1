...
<div class="breadcrumbs">
    ...
    <a href="<?= SITE_PATH . 'adminpanel/post_management'; ?>">Manage Posts</a>&nbsp;&gt;&nbsp;
    <a href="<?= MODULE_PAGE_NAME ?>?pid=<?php echo $this->input->get_post('pid'); ?>">Manage Post Gallery </a>&nbsp; &gt;&nbsp; 
    <?php
    if (!empty($eid)) {
        ?><span class="current">Edit Post Image</span>  <?php
    } else {
        ?><span class="current">Add New Image</span> <?php
    }
    ?>
...
<div id="page-inner">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <?php
                $attributes = array('name' => 'frmpostgallery', 'id' => 'frmpostgallery', 'enctype' => 'multipart/form-data');
                echo form_open($action, $attributes);
                ?>
                <?php
                if ($eid == '') {
                    $count_photo = $this->module_model->count_photo($this->input->get_post('pid'));
                    if ($count_photo == '0') {
                        $gi = '1';
                ...
                <input type="hidden" id="pdi" name="pid" value="<?= $this->input->get_post('pid'); ?>" />
                <?php if ($eid == '') { ?>
                            ...
                            <div class="form-group" style="padding-top:  10px">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ?>" name="var_image">
                                           <?php
                                           if (!empty($eid)) {
                                               $imagepath = 'upimages/post_gallery/images/' . $row['var_image'];
                                               ?>
                                               <?php
    ...
    <div class="col-sm-12" style="margin-top: 20px; ">
        ...
        <a class="btn btn-primary" onClick="SetBackground()" href="<?php echo MODULE_PAGE_NAME; ?>?pid=<?php echo $this->input->get_post('pid'); ?>">Cancel</a></button>
    </div>
