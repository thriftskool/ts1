...
define("SMTP_USER", "no-reply@thriftskool.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PASSWORD", "Thriftskool22"); //Password for SMTP authentication
