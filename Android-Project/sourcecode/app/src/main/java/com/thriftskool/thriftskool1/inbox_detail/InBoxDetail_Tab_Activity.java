 ...
 */
public class InBoxDetail_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    public static String str_PostId="",str_ThreadId="",str_postName="",str_chrread,str_userId,str_postUserId,str_ownerName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_ThreadId = intent.getStringExtra("ThreadId");
        str_postName = intent.getStringExtra("PostName");
        str_userId = intent.getStringExtra("UserId");

       str_ownerName = intent.getStringExtra("OwnerName");
        maping();
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(InBoxDetail_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(InBoxDetail_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(InBoxDetail_Tab_Activity.this,InBoxDetailScreen_Activity.class);
      ...
      /*  ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(InBoxDetail_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(InBoxDetail_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
