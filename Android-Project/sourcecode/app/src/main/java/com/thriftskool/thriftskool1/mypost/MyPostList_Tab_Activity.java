 ...
 */
public class MyPostList_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(MyPostList_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(MyPostList_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(MyPostList_Tab_Activity.this,MyPostListScreen_Activity.class);
       ...
       /* ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(MyPostList_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(MyPostList_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
