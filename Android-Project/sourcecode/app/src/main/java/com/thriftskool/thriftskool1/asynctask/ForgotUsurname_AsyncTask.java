 ...
 */
public class ForgotUsurname_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public ForgotUsurname_AsyncTask(Context contex) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            String response = Utility.postRequest(Comman.URL+"forgotname", json.toString(),context);
