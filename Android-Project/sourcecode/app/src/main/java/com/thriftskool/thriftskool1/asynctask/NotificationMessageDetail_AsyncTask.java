 ...
 */
public class NotificationMessageDetail_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public NotificationMessageDetail_AsyncTask(Context contex, List<InBoxDetaiList_Been> messageList, AmazingListView lv_listView,TextView tv_title ,String str_postName,  List<InBoxDetaiList_Been> messageList1 ,List<Pair<String, List<InBoxDetaiList_Been>>> pairMessageList ) {
        ...
        try
        {
            ...
            if (result.getString("status").trim().equalsIgnoreCase("200"))
            {
                ...
                for (int i=0; i<detailArray.length(); i++)
                {
                    ...
                    NotificationMessageDetailScreen_Activity.str_postUserId =  detailItem.getString("post_user_id").trim();
                }
