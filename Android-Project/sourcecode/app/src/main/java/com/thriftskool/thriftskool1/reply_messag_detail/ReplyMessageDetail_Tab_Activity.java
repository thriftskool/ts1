 ...
 */
public class ReplyMessageDetail_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    public static String str_PostId="",str_ThreadId="",str_postName="",str_chrread,str_userId,str_postUserid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_postName = intent.getStringExtra("PostName");


        Log.e("Heloooo ","Hiiii: "+str_userId);
        Log.e("Heloooo ","Hiiii: "+str_PostId);
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(ReplyMessageDetail_Tab_Activity.this,ReplyMessageDetailScreen_Activity.class);
        ...
        Intent postintent = new Intent(ReplyMessageDetail_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(ReplyMessageDetail_Tab_Activity.this,ProfileScreen_Activity.class);
      ...
      /*  ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(ReplyMessageDetail_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(ReplyMessageDetail_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            ReplyMessageDetail_Tab_Activity activity = (ReplyMessageDetail_Tab_Activity)getLocalActivityManager().getCurrentActivity();
