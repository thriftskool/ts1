...
/**
 * Created by etiloxadmin on 19/8/15.
 */
public class EditProfile_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(EditProfile_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(EditProfile_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(EditProfile_Tab_Activity.this,EditProfileScreen_Activity.class);
    ...
    /*    ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(EditProfile_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(EditProfile_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            EditProfile_Tab_Activity activity = (EditProfile_Tab_Activity)getLocalActivityManager().getCurrentActivity();
