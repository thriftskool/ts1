 ...
 */
public class CreateBuzz_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public CreateBuzz_AsyncTask(Context contex) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            String response = Utility.postRequest(Comman.URL+"buzz_insert", params[0],context);
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        try
        {
            ...
            if (result.getString("status").trim().equalsIgnoreCase("201"))
            {
                ...
                //Toast.makeText(context, context.getString(R.string.server_createbuzz_alert), Toast.LENGTH_LONG).show();
