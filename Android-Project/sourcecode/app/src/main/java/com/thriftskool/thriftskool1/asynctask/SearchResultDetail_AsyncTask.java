 ...
 */
public class SearchResultDetail_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public SearchResultDetail_AsyncTask(Context contex,  ArrayList<String> imageList, ViewPager viewpag_viewPager, String str_value, TextView tv_title, TextView tv_expdate, TextView tv_expday,TextView tv_description , TextView tv_favorite, TextView tv_report, TextView tv_mail, TextView tv_call, TextView tv_viewCode) {
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        try
        {
            ...
            if (result.getString("status").trim().equalsIgnoreCase("200"))
            {
                ...
                if (str_value.trim().equalsIgnoreCase("PM")){


                    JSONObject detailItem = result.getJSONObject("Details");

                    SearchResultDetailScreen_Activity.str_replyMessage = result.getString("thread_cnt");
                    ...
                    SearchResultDetail_Tab_Activity.str_Status=detailItem.getString("status");
                    ...
                    {
                        tv_expday.setText("Expires in "+DateCoversion.getDiffrenceOfData(DateCoversion.getCurrentData(),detailItem.getString("expirydate"))+" day");
                    ...
                    }else if (DateCoversion.getDiffrenceOfData(DateCoversion.getCurrentData(),detailItem.getString("expirydate"))<0)
                    {
                        ...
                        tv_expday.setText("Expires in "+DateCoversion.getDiffrenceOfData(DateCoversion.getCurrentData(),detailItem.getString("expirydate"))+" days");
                ...
                }else if (str_value.trim().equalsIgnoreCase("CB")){
