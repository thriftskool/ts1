 ...
 */
public class ReplyMessage_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    private Intent intent;
    public static  String str_ID="",str_userId,str_postName;
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(ReplyMessage_Tab_Activity.this,ReplyMessageScreen_Activity.class);
        ...
        Intent postintent = new Intent(ReplyMessage_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(ReplyMessage_Tab_Activity.this,ProfileScreen_Activity.class);
      ...
      /*  ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(ReplyMessage_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(ReplyMessage_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
