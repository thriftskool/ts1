package com.thriftskool.thriftskool1.search_edit_buzz;
...
public class SearchResultEditBuzzScreen_Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap = SessionStore.getUserDetails(SearchResultEditBuzzScreen_Activity.this, Comman.PRIFRENS_NAME);
        hasMapcount = sessionsCount.getCount(SearchResultEditBuzzScreen_Activity.this, Comman.PRIFRENS_NAME);
    ...
    private void maping() {
        ...
        iv_photo1.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        iv_photo2.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        iv_photo3.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        iv_photo4.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        ll_expriyDate.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        tv_submit.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
        tv_save.setOnClickListener(SearchResultEditBuzzScreen_Activity.this);
    ...
    private void setValue() {
        ...
        SearchEditBuzz_AsyncTask editpost = new SearchEditBuzz_AsyncTask(SearchResultEditBuzzScreen_Activity.this);
        editpost.execute(SearchResultEditBuzz_Tab_Activity.str_userId, SearchResultEditBuzz_Tab_Activity.str_buzzId);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.EditBuzzScreen_submit:
                ...
                if (CheckInterNetConnection.isNetworkAvailable(SearchResultEditBuzzScreen_Activity.this))
                {
                ...
                else
                {
                    ...
                    new AlertDialog.Builder(SearchResultEditBuzzScreen_Activity.this)
                            .setTitle("Alert!")
            ...
            case R.id.Header_Save:
                ...
                intent = new Intent(SearchResultEditBuzzScreen_Activity.this, NotificationListScreen_Activity.class);
    ...
    private void post() {
        ...
        if (imageList.size()>0)
        {
            ...
            if (!et_title.getText().toString().trim().equalsIgnoreCase(""))
            {
                ...
                if (!et_description.getText().toString().trim().equalsIgnoreCase(""))
                {
                        ...
                        try {
                            ...
                            json.put("buzz_id", Integer.parseInt(SearchResultEditBuzz_Tab_Activity.str_buzzId));
                            ...
                            for (int i = 0; i < imageList.size(); i++) {
                                ...
                                jj.put("title", SearchResultEditBuzz_Tab_Activity.str_buzzId+"_"+(i + 1));
                            ...
                            UpdateBuzz_AsyncTask po = new UpdateBuzz_AsyncTask(SearchResultEditBuzzScreen_Activity.this);
                ...
                else
                {
                    ...
                    Toast toast=  Toast.makeText(SearchResultEditBuzzScreen_Activity.this, getString(R.string.description_alert_postscreen), Toast.LENGTH_SHORT);
            ...
            else
            {
                ...
                Toast toast= Toast.makeText(SearchResultEditBuzzScreen_Activity.this, getString(R.string.blank_title_alert), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER,0,0);
                toast.show();
            }
        }
        else
        {
            ...
            Toast toast=  Toast.makeText(SearchResultEditBuzzScreen_Activity.this, getString(R.string.photo_alert_postscreen), Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER,0,0);
            toast.show();
        }
    ...
    public class SearchEditBuzz_AsyncTask extends AsyncTask<String, Integer, JSONObject> {

        ProgressDialog progressDialog;
        Context context;


        public SearchEditBuzz_AsyncTask(Context contex) {
...
//********** Download Image ***********************************************************************************************************************************************************************
    ...
    protected void onPause() {
        super.onPause();
        CrearCashMemmory.trimCache(SearchResultEditBuzzScreen_Activity.this);
    }
