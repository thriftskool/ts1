...
import com.thriftskool.thriftskool1.edit_post.EditPostScreen_Activity;
 ...
 */
public class EditBuzz_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(EditBuzz_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(EditBuzz_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(EditBuzz_Tab_Activity.this,EditBuzzScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(EditBuzz_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(EditBuzz_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
