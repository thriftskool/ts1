 ...
 */
public class BuzzReportCount_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public BuzzReportCount_AsyncTask(Context contex) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            String response = Utility.postRequest(Comman.URL+"buzz_count", json.toString(),context);
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        try
        {
            ...
            if (result.getString("status").trim().equalsIgnoreCase("200"))
            {
               ...
               // Toast.makeText(context, context.getString(R.string.server_report_alert), Toast.LENGTH_LONG).show();
