 ...
 */
public class WatchList_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(WatchList_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(WatchList_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(WatchList_Tab_Activity.this,WatchListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(WatchList_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
