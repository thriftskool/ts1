 ...
 */
public class ContectUs_AsyncTask  extends AsyncTask<String, Integer, JSONObject> {
    ...
    public ContectUs_AsyncTask(Context contex) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            json.put("user_name", (params[1]));
            json.put("user_email", (params[2]));
            json.put("message", (params[3]));
            json.put("dt_createdate", (params[4]));



            String response = Utility.postRequest(Comman.URL+"contactus", json.toString(),context);
