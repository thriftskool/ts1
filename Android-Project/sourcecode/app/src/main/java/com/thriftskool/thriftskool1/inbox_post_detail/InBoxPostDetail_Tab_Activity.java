 ...
 */
public class InBoxPostDetail_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    private Intent intent;
    public static String  str_Id,str_userId, str_type,str_title,str_postUserId="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_postUserId = intent.getStringExtra("PostUserId");
        str_type="PM";
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(InBoxPostDetail_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(InBoxPostDetail_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(InBoxPostDetail_Tab_Activity.this,InBoxPostDetailScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(InBoxPostDetail_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(InBoxPostDetail_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
