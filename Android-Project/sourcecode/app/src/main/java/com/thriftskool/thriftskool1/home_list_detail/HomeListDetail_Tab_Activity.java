...
public class HomeListDetail_Tab_Activity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_Name = intent.getStringExtra("N ame");
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(HomeListDetail_Tab_Activity.this,HomeListDetailScreen_Activity.class);
       // homeintent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        Intent postintent = new Intent(HomeListDetail_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(HomeListDetail_Tab_Activity.this,ProfileScreen_Activity.class);
    ...
    /*    ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(HomeListDetail_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(HomeListDetail_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
