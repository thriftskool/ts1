...
import com.thriftskool.thriftskool1.MostRecentPost.MostRecentPost_Activity;
...
/**
 * Created by etiloxadmin on 9/12/15.
 */
public class MostRecentPost_AsyncTask extends AsyncTask<String, Integer, JSONObject>
{
    ...
    public MostRecentPost_AsyncTask(Context contex,  List<HomeList_Been> homeList , ListView lv_listView, TextView tv_alert, ArrayAdapter<HomeList_Been> adapter,View footerView,String start, String end,int filterValue) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            String response = Utility.postRequest(Comman.URL+"latest_post_list", json.toString(),context);
        ...
        try
        {
            ...
            if (result.getString("status").trim().equalsIgnoreCase("200"))
            {
                ...
                if (detailArray.length()<10)
                {
                    ...
                    MostRecentPost_Activity.mostrecentpostdmoreFlage=true;
                    ...
                    MostRecentPost_Activity.mostrecentpostdmoreFlage=false;
                ...
                tv_alert.setText(context.getString(R.string.blank_mostrecentpost_alert));
