 ...
 */
public class SearchEditPost_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(SearchEditPost_Tab_Activity.this,SearchEditPostScreen_Activity.class);
        ...
        Intent postintent = new Intent(SearchEditPost_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(SearchEditPost_Tab_Activity.this,ProfileScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(SearchEditPost_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(SearchEditPost_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
