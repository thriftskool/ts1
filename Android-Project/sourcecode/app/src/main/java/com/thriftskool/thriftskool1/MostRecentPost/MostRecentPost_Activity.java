package com.thriftskool.thriftskool1.MostRecentPost;
...
import com.thriftskool.thriftskool1.asynctask.MostRecentPost_AsyncTask;
...
public class MostRecentPost_Activity extends Activity implements View.OnClickListener
{
    ...
    public static boolean mostrecentpostdmoreFlage=false;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_most_recent_post_);

        hashMap = SessionStore.getUserDetails(MostRecentPost_Activity.this, Comman.PRIFRENS_NAME);
        hasMapcount = sessionsCount.getCount(MostRecentPost_Activity.this, Comman.PRIFRENS_NAME);
    ...
    private void maping()
    {
        ...
        lv_listView = (ListView)findViewById(R.id.MostRecent_ListView);
        ...
        tv_alert = (TextView)findViewById(R.id.MostRecent_textAlert);
    ...
    private void setValue()
    {
        ...
        tv_title.setText("Recently Added");

        MostRecentPost_AsyncTask home = new MostRecentPost_AsyncTask(MostRecentPost_Activity.this, homeList, lv_listView ,tv_alert,adapter,footerView,""+start, ""+end,filterflage);
        home.execute(hashMap.get(SessionStore.USER_ID),hashMap.get(SessionStore.UNIVERSITY_ID), ""+start, ""+end);
        ...
        lv_listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if ((firstVisibleItem + visibleItemCount - 1) == homeList.size() && !(mostrecentpostdmoreFlage)) {

                    mostrecentpostdmoreFlage = true;
                    start = start + 10;
                    end = 10;
       ...
       tv_filter.setOnClickListener(MostRecentPost_Activity.this);
        tv_save.setOnClickListener(MostRecentPost_Activity.this);
...
//********* on Click *************************************************************************************************************************************************************************************
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.Header_Save:
                ...
                Intent intent = new Intent(MostRecentPost_Activity.this, NotificationListScreen_Activity.class);
    ...
    {
        adapter= new HomeLIst_Adapter(MostRecentPost_Activity.this,R.layout.home_list_row, homeList);
        ...
        dialog = new Dialog(MostRecentPost_Activity.this,R.style.PauseDialog);
    ...
    protected void onPause() {
        super.onPause();
        CrearCashMemmory.trimCache(MostRecentPost_Activity.this);
    }
