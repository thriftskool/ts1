 ...
 */
public class ContactAppAdmin_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(ContactAppAdmin_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(ContactAppAdmin_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(ContactAppAdmin_Tab_Activity.this,ContactAppAdminScreen_Activity.class);
       ...
       /* ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(ContactAppAdmin_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(ContactAppAdmin_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
