...
import com.thriftskool.thriftskool1.campus_buzz_details.CampusBuzzDetailsScreen_Activity;
 ...
 */
public class CampusDealDetail_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    private Intent intent;
    public static String str_title, str_price, str_description, str_expDate, str_Id,str_creatDate,str_dealCode,str_userId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_dealCode =  intent.getStringExtra("DealCode");
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(CampusDealDetail_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(CampusDealDetail_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(CampusDealDetail_Tab_Activity.this,ProfileScreen_Activity.class);
      ...
      /*  ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(CampusDealDetail_Tab_Activity.this,CampusDealDetailScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(CampusDealDetail_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
