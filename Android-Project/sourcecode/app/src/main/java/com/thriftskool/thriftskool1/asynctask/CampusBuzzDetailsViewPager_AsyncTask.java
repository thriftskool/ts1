 ...
 */
public class CampusBuzzDetailsViewPager_AsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public CampusBuzzDetailsViewPager_AsyncTask(Context contex,  ArrayList<String> imageList, ViewPager viewpag_viewPager) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try
        {
            ...
            String response = Utility.postRequest(Comman.URL+"buzz_detail", json.toString(),context);
