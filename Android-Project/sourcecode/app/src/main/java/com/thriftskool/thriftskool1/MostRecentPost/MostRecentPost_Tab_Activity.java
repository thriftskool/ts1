...
public class MostRecentPost_Tab_Activity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_most_recent_post__tab_);
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(MostRecentPost_Tab_Activity.this,MostRecentPost_Activity.class);
        ...
        Intent postintent = new Intent(MostRecentPost_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(MostRecentPost_Tab_Activity.this,ProfileScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(WatchList_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(MostRecentPost_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
