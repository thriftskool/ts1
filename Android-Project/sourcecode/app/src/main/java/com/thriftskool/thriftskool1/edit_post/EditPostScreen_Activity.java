...
public class EditPostScreen_Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap = SessionStore.getUserDetails(EditPostScreen_Activity.this, Comman.PRIFRENS_NAME);
        hasMapcount = sessionsCount.getCount(EditPostScreen_Activity.this, Comman.PRIFRENS_NAME);
    ...
    private void maping() {
        ...
        iv_photo1.setOnClickListener(EditPostScreen_Activity.this);
        iv_photo2.setOnClickListener(EditPostScreen_Activity.this);
        iv_photo3.setOnClickListener(EditPostScreen_Activity.this);
        iv_photo4.setOnClickListener(EditPostScreen_Activity.this);
        ll_ChoseCategory.setOnClickListener(EditPostScreen_Activity.this);
        ll_expriyDate.setOnClickListener(EditPostScreen_Activity.this);
        tv_submit.setOnClickListener(EditPostScreen_Activity.this);
        tv_save.setOnClickListener(EditPostScreen_Activity.this);
    ...
    private void setValue() {
        ...
        EditPost_AsyncTask editpost = new EditPost_AsyncTask(EditPostScreen_Activity.this);
        editpost.execute(EditPost_Tab_Activity.str_userId, EditPost_Tab_Activity.str_postId);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.EditPostScreen_chooseCategory:
                ...
                Intent intent = new Intent(EditPostScreen_Activity.this, CategoryScreen_Activity.class);
            ...
            case R.id.EditPostScreen_submit:
                        ...
                        if (CheckInterNetConnection.isNetworkAvailable(EditPostScreen_Activity.this))
                        {
                        ...
                        new AlertDialog.Builder(EditPostScreen_Activity.this)
                        .setTitle("Alert!")
            ...
            case R.id.Header_Save:
                 ...
                 intent = new Intent(EditPostScreen_Activity.this, NotificationListScreen_Activity.class);
    ...
    private void post() {
        ...
        if (!str_categoryId.trim().equalsIgnoreCase("")) {
            ...
            if (imageList.size() > 0) {
                ...
                if (!et_title.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    if (!et_description.getText().toString().trim().equalsIgnoreCase("")) {
                        ...
                        if (!et_price.getText().toString().trim().equalsIgnoreCase("")) {
                            ...
                            // if (chb_privacyPolicy.isChecked())
                            {
                                try {
                                    ...
                                    json.put("post_id", Integer.parseInt(EditPost_Tab_Activity.str_postId));
                                    ...
                                    for (int i = 0; i < imageList.size(); i++) {
                                        ...
                                        jj.put("title", EditPost_Tab_Activity.str_postId+"_"+(i + 1));
                                    ...
                                    UpdatePost_AsyncTask post = new UpdatePost_AsyncTask(EditPostScreen_Activity.this);
                            ...
                            Toast toast=  Toast.makeText(EditPostScreen_Activity.this, getString(R.string.price_alert_postscreen), Toast.LENGTH_SHORT);
                        ...
                        Toast toast=Toast.makeText(EditPostScreen_Activity.this, getString(R.string.description_alert_postscreen), Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER,0,0);
                        toast.show();
                    }
                } else {
                    ...
                    Toast toast= Toast.makeText(EditPostScreen_Activity.this, getString(R.string.blank_title_alert), Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.CENTER,0,0);
                    toast.show();
                }
            } else {
                ...
                Toast toast= Toast.makeText(EditPostScreen_Activity.this, getString(R.string.photo_alert_postscreen), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER,0,0);
                toast.show();
            }
        } else {
            ...
            Toast toast= Toast.makeText(EditPostScreen_Activity.this, getString(R.string.blank_choosecategory_alert), Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER,0,0);
            toast.show();
        }
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                ...
                if (result.getString("status").trim().equalsIgnoreCase("200")) {
                    ...
                    Log.e("Exception", " Category List Exception PAnkaja : " + detailArray.length());
                    for (int i = 0; i < detailArray.length(); i++) {

                        JSONObject detailItem = detailArray.getJSONObject(i);
                        new DownloadImage11().execute(detailItem.getString("photo_id"), result.getString("imagepath").trim() + "" + detailItem.getString("post_image").trim());
                    }
...
//********** Download Image ***********************************************************************************************************************************************************************
    ...
    private class DownloadImage11 extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... imageurl) {
            Log.e("Post ID","IDIDIDIDIID: "+imageurl[1] );


            id = imageurl[0];

            String imageURL = imageurl[1];
            //String imageURL = "https://upload.wikimedia.org/wikipedia/commons/2/23/Lake_mapourika_NZ.jpeg";

            Bitmap bitmap = null;
            try {

              /*  InputStream input = new java.net.URL(imageURL.trim().replaceAll(" ","")).openStream();
                // Decode Bitmap
                bitmap = BitmapFactory.decodeStream(input);*/

                URL imageuu = new URL(imageURL);
                bitmap = BitmapFactory.decodeStream(imageuu.openStream());
    ...
    public Bitmap getResizedBitmap(Bitmap bm, int newHeight, int newWidth) {
        ...
        // "RECREATE" THE NEW BITMAP
         resizedBitmap = Bitmap.createBitmap(bm, 0, 0, width, height, matrix, false);
            ...
            Log.e("Download Image Exception","Download Image Exception: "+e.getMessage());
    ...
    protected void onPause() {
        super.onPause();
        CrearCashMemmory.trimCache(EditPostScreen_Activity.this);
    }
