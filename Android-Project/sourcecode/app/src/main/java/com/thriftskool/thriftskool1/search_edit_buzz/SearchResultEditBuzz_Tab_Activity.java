...
import com.thriftskool.thriftskool1.edit_buzz.EditBuzzScreen_Activity;
...
/**
 * Created by etiloxadmin on 7/10/15.
 */
public class SearchResultEditBuzz_Tab_Activity extends TabActivity {

    private TabHost th_tabHost;
    private TabHost.TabSpec ts_home, ts_post, ts_profile, ts_deals, ts_buzz;
    public static String str_buzzId, str_userId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        str_buzzId = intent.getStringExtra("BuzzId");
        str_userId = intent.getStringExtra("UserId");


        Log.e("fsdfsdfsd","dsfdsfdsf: "+str_buzzId);
        Log.e("fsdfsdfsd","dsfdsfdsf: "+str_userId);
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(SearchResultEditBuzz_Tab_Activity.this,SearchResultEditBuzzScreen_Activity.class);
        ...
        Intent postintent = new Intent(SearchResultEditBuzz_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(SearchResultEditBuzz_Tab_Activity.this,ProfileScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(SearchResultEditBuzz_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(SearchResultEditBuzz_Tab_Activity.this,CampusBuzzListScreen_Activity.class);
