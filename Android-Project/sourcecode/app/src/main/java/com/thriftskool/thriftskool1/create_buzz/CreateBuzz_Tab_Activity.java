 ...
 */
public class CreateBuzz_Tab_Activity extends TabActivity {
    ...
    private void maping()
    {
        ...
        Intent homeintent = new Intent(CreateBuzz_Tab_Activity.this,HomeScreen_Activity.class);
        ...
        Intent postintent = new Intent(CreateBuzz_Tab_Activity.this,PostScreen_Activity.class);
        ...
        Intent profileintent = new Intent(CreateBuzz_Tab_Activity.this,ProfileScreen_Activity.class);
     ...
     /*   ts_deals = th_tabHost.newTabSpec(getString(R.string.deals_hometabscreen));
        ...
        Intent dealsintent = new Intent(CreateBuzz_Tab_Activity.this,CampusDealListScreen_Activity.class);
...
*/
        ...
        Intent buzzintent = new Intent(CreateBuzz_Tab_Activity.this,CreateBuzzScreen_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            CreateBuzz_Tab_Activity activity = (CreateBuzz_Tab_Activity)getLocalActivityManager().getCurrentActivity();
